...
/**
 * 
 * A panel that displays information about a Gridscheduler.
 * 
...
public class GridSchedulerStatusPanel extends StatusPanel {
	...
	private final static int panelWidth = 450;
    ...
    protected void paintComponent(Graphics g) {
		...
		g.drawString("Log other GS ", x, y);
	    g.drawString("" + scheduler.getLogItems(), x + colWidth, y);
	    y += fontHeight;
    }	
